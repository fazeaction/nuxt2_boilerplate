...
export const mutations = {
    ...
    setBreakpoint( state, { breakpoint, assetSufix }) {
    ...
    setViewport( state, { w, h } ){
        state.template = w > 768 ? "desktop" : "mobile",
...
export const actions = {
    ...
    _updateBreakpoint({ state, commit }) {
        ...
        if(state.breakpoint !== breakpoint){
            if (breakpoint.includes("mobile")) assetSufix = "mobile";
            else if (breakpoint == "tablet-portrait") assetSufix = "tablet";
            else assetSufix = "desktop";
            commit("setBreakpoint", { breakpoint, assetSufix });
        }
    },
    ...
    checkDevice({ state, commit }) {
        ...
        commit("setValueFor", { key: "ie", value: navigator.userAgent.indexOf("MSIE ") > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./) })
